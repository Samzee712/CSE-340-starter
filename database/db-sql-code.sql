...
ALTER TYPE public.account_type OWNER TO cse340sa;
...
-- Foreign key relationship between inventory and classification
...
-- Query 6 from Task 1: Update all image paths
UPDATE public.inventory
SET 
